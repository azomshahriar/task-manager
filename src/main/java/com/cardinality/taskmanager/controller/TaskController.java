...
public class TaskController {
    ...
    @Operation(summary = "Create a new task", description = "", tags={ "task" })
    @PostMapping
    ...
    @Operation(summary = "List of Task", description = "", tags={ "task" })
    @GetMapping
    ...
    @Operation(summary = " Task detail", description = "", tags={ "task" })
    @GetMapping("/{id}")
    public ResponseEntity<TaskDto> getTaskDetail(@PathVariable(name = "id",required = true) Long id){
        log.info("Get Task.  Id:{}.");
        return ResponseEntity.ok(taskService.getTask(id));
    }

    @Operation(summary = "List of Task By Project", description = "", tags={ "task" })
    @GetMapping("/byProject/{projectId}")
    public ResponseEntity<Page<TaskDto>> getTaskByProject(@PathVariable(name = "projectId",required = true) Long projectId, Pageable pageable){
        log.info("Get Task By project. Project Id:{}.");
        return ResponseEntity.ok(taskService.getTasksByProject(projectId,pageable));
    }
    @Operation(summary = "List of Expired Task", description = "", tags={ "task" })
    @GetMapping("/expired")
    ...
    @Operation(summary = "Update Task", description = "", tags={ "task" })
    @PutMapping()
    ...
    @Operation(summary = "Search Task", description = "Search Task By Project Id or Status or expired.", tags={ "task" })
    @GetMapping("/search")
